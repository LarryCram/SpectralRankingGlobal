...
CONCORDANCE = [
    ...
    (12, ['Social Sciences'],
         'Broad proxy — no dedicated Arts & Humanities category; Social Sciences is closest'),
    ...
    (14, ['Economics and Business'],
         'Good match; note: same Clarivate category used for fields 18, 20'),
    (15, ['Engineering'],
         'Shared with field 22; chemical engineering subsumed in Engineering'),
    (16, ['Chemistry'],
         'Good match'),
    (17, ['Computer Science'],
         'Good match'),
    (18, ['Economics and Business'],
         'Shared with fields 14, 20; Decision Sciences subsumed in Economics and Business'),
    (19, ['Geosciences'],
         'Good match; Space Science excluded (planetary astro is minor in field 19)'),
    (20, ['Economics and Business'],
         'Good match; note: same Clarivate category used for fields 14, 18'),
    (21, ['Engineering'],
         'Shared with field 22; energy research subsumed in Engineering'),
    (22, ['Engineering'],
         'Good match'),
    ...
    (29, ['Clinical Medicine'],
         'Shared with field 27; Nursing subsumed in Clinical Medicine'),
    ...
    (33, ['Social Sciences'],
         'Good match; note: same Clarivate category used for field 12'),
    (34, ['Plant and Animal Science'],
         'Partial — animal science part overlaps; no dedicated veterinary category'),
    (35, ['Clinical Medicine'],
         'Shared with field 27; Dentistry subsumed in Clinical Medicine'),
    (36, ['Clinical Medicine'],
         'Shared with field 27; Health Professions subsumed in Clinical Medicine'),
]
